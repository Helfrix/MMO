...
public abstract class customGuiContainer extends customGuiScreen
{
	...
	private boolean isMouseOverXPBar(int posX, int posY, int p_146981_2_, int p_146981_3_)
	{
		return this.isMouseOverXPBar2(posX, posY, 95, 11, p_146981_2_, p_146981_3_);
	}

	protected boolean isMouseOverXPBar2(int p_146978_1_, int p_146978_2_, int p_146978_3_, int p_146978_4_, int p_146978_5_, int p_146978_6_)
	{
		int k1 = this.guiLeft;
		int l1 = this.guiTop;
		p_146978_5_ -= k1;
	 ...
	 */
	public void drawScreen(int mouseXpos, int mouseYpos, float p_73863_3_)
	{
		this.drawDefaultBackground();
		int k = this.guiLeft; 
		int l = this.guiTop;
		this.drawGuiContainerBackgroundLayer(p_73863_3_, mouseXpos, mouseYpos);
		GL11.glDisable(GL12.GL_RESCALE_NORMAL);
		RenderHelper.disableStandardItemLighting();
		GL11.glDisable(GL11.GL_LIGHTING);
		GL11.glDisable(GL11.GL_DEPTH_TEST);
		super.drawScreen(mouseXpos, mouseYpos, p_73863_3_);
		...
		for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1)
		{
			...
			int slotX = slot.xDisplayPosition - 2;
			int slotY = slot.yDisplayPosition - 2;
			...
			if (this.isMouseOverSlot(slot, mouseXpos, mouseYpos) && slot.func_111238_b())
			{
				this.theSlot = slot;
				GL11.glDisable(GL11.GL_LIGHTING);
				GL11.glDisable(GL11.GL_DEPTH_TEST);
				GL11.glColorMask(true, true, true, false);
				this.drawTexturedModalRect(slotX, slotY, 0, 87, 20, 20);
			...
			else
			{
				...
				GL11.glDisable(GL11.GL_DEPTH_TEST);
				GL11.glColorMask(true, true, true, false);
				this.drawTexturedModalRect(slotX, slotY, 0, 47, 20, 20);
				GL11.glColorMask(true, true, true, true);
				GL11.glEnable(GL11.GL_LIGHTING);
				GL11.glEnable(GL11.GL_DEPTH_TEST);
		...
		GL11.glDisable(GL11.GL_LIGHTING);
		this.drawGuiContainerForegroundLayer(mouseXpos, mouseYpos);
		GL11.glEnable(GL11.GL_LIGHTING);
		...
		if (itemstack != null)
		{
			...
			this.drawItemStack(itemstack, mouseXpos - k - b0, mouseYpos - l - k1, s);
		}
		...
		{
			if (this.isMouseOverXPBar(5,(i2 * 13) + 97, mouseXpos, mouseYpos)){
				this.renderToolTipXP(fontRendererObj, gmh.getFormattedBigNumber(props.getXP(i2))+"/"+gmh.getFormattedBigNumber(gmh.getMaxXP(props.getLevel(i2))), mouseXpos, mouseYpos);
			}
		}
		if (inventoryplayer.getItemStack() == null && this.theSlot != null && this.theSlot.getHasStack())
		{
			ItemStack itemstack1 = this.theSlot.getStack();
			this.renderToolTip(itemstack1, mouseXpos, mouseYpos);
		}
	...
	{
		if (p_73869_2_ == 1 || p_73869_2_ == KeyHandler.keys[0].getKeyCode())
		{
