...
import uk.co.animecraft.mmo.Message.AbstractMessage;
...
import uk.co.animecraft.mmo.Network.Magic.MagicMessage;
import uk.co.animecraft.mmo.Network.Magic.MagicPacket;
...
public class PacketHandler
{
	 ...
	 */
	private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(MMOmod.MODID);
	...
	public static final void registerPackets() {
		...
		//registerMessage(SyncPropsMessage.class);
		registerMessage(SyncAttackXPMessage.class);
